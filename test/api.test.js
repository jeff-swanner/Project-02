...
//           .to.be.an('object')
//           .that.includes({ UserId: 6, department: '', product: '', price: });
...
//           .to.be.an('object')
//           .that.includes({ UserId: 4, department: '', product: '', price: });

//           expect(responseBody[3])
//           .to.be.an('object')
//           .that.includes({ UserId: 3, department: '', product: '', price: });

//           expect(responseBody[4])
//           .to.be.an('object')
//           .that.includes({ UserId: 5, department: '', product: '', price: });

//           expect(responseBody[5])
//           .to.be.an('object')
//           .that.includes({ UserId: 5, department: '', product: '', price: });

//           expect(responseBody[0])
//           .to.be.an('object')
//           .that.includes({ UserIddepartment: '', product: '', price: });
